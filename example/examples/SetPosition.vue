  ...
  <example-wrapper title="Set center of map to current location">
    <div class="instructions">
      <p class="instructions-title">
        Press the button below to center the map on your location. Make sure you grant access to your location if asked!
      </p>
      <button class="instructions-action" @click="getLocation">Move to my location</button>
      <span>Center: {{ center }}</span>
    </div>
    <template #description>
      <p>
        You can add many
        <a href="https://developers.google.com/maps/documentation/javascript/reference/map#MapOptions" target="_blank"
          >options</a
        >
